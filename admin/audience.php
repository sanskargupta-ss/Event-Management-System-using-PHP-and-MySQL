				...
				<div class="card">
					<div class="card-header">
						...
						<span class="">
							...
							<button class="btn btn-success btn-block btn-sm col-sm-2 float-right" type="button" id="new_register">
						...
						<table class="table table-bordered table-condensed table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-outline-success edit_register" type="button" data-id="<?php echo $row['id'] ?>" >Edit</button>
