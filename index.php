...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2022 - <?php echo $_SESSION['system']['name'] ?> | <a class="text-success" href="https://github.com/sanskargupta-ss" target="_blank">SANSKAR GUPTA</a></div></div>
        </footer>
